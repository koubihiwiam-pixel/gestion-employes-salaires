...
<div class="sidebar">
    ...
    <button class="btn btn-primary" onclick="window.location.href='conge.php?employe_id=<?php echo $employe_id; ?>'">Demande un congé</button>
...
<div class="content">
    <div class="header">
        <h2>Demande de Congé pour l'Employé ID: <?php echo $employe_id; ?></h2>
    </div>
